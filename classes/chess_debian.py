...
class chess_debian(chessInterface):
            ...
            for Z in range(0,3):
                ...
                for X in range(0, 8):
                    ...
                    if Z == 0 or Z == 2:
                        if X == 0:
                            strValue = '  '
                        strValue = strValue + '\033[1;' + str(bkg) + ';' + str(bkg) + 'm' + "     " + '\033[0m'
                    else:
                        if X == 0:
                            strValue = str(8 - Y) + ' '
                        ...
                        if (pionClass == None):
                            ...
                            color_pion = 34
                            pionString = pionClass.getLetter()
                        strValue = strValue + '\033[1;' + str(bkg) + ';' + str(color_pion) + 'm \033[0m\033[' + str(bkg_select) + ';' + str(color_pion) + 'm ' + pionString + ' \033[0m\033[1;' + str(bkg) + ';' + str(color_pion) + 'm \033[0m'
                print(strValue)
